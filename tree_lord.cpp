...
int main() {
    ...
    RealTree.addNode(90909, RealTree.root);
    RealTree.addNode(20, RealTree.root);
    ...
    //find
    TreeNode<int>* foundNode = RealTree.find_node(RealTree.root, [](int value) { return value == 1909; });
    if (foundNode) {
    ...
    //sort
        //testtest1 - sorteaza nodurile fii ai radacinii
 ...
 //insertindex
    ...
    cout << RealTree.CountNodes(RealTree.root)<<endl;                //final count
